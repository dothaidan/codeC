// HỌC C CÙNG MÌNH
/*Code trò chơi chẵn lẻ bằng C vui vui
- ý tưởng :
- kiểm tra độ tuổi lớn 18 tuổi thì được chơi nha ae =))
- người chơi có một số tiền
- và sẽ random các con số từ 1-6
- nếu người chơi chọn chẵn và con xúc sắc ra chẵn người chơi thắng và ngược lại người chơi thua
- nếu người chơi chọn lẻ và con xúc sắc ra lẻ thì người chơi thắng ngược lại người chơi thua
*/
#include <stdio.h>
#include <stdlib.h>
#include <windows.h>
